...
public class WorldGen {
    ...
    public static void addStoneWorldGen(Block stoneBlock) {
        ...
        ConfiguredFeature<?, ?> featureOreOverworld = Feature.ORE
            ...
            .decorate(Decorator.RANGE.configure(new RangeDecoratorConfig(ConstantHeightProvider.create(YOffset.aboveBottom(64)))))
            .spreadHorizontally()
            .repeat(15);

        RegistryKey<ConfiguredFeature<?, ?>> oreOverworld = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY, new Identifier(Ref.MOD_ID, "ore_" + blockName + "_overworld"));
